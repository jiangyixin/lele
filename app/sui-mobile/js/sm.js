...
+function($) {
    ...
    Router.prototype._switchToSection = function(sectionId) {
        ...
        this._animateSection($curPage, $newPage, DIRECTION.pageFade);
     ...
     * @param {String} direction 动画切换方向，默认是 DIRECTION.pageFade
     * @private
     */
    ...
    Router.prototype._animateElement = function($from, $to, direction) {
        ...
        switch(direction) {
            case DIRECTION.pageFade:
                classForFrom = 'page-fade-out';
                classForTo = 'page-fade-in';
                break;
    ...
    Router.prototype._back = function(state, fromState) {
        if (this._isTheSameDocument(state.url.full, fromState.url.full)) {
            ...
            if ($newPage.length) {
                ...
                this._animateSection($currentPage, $newPage, DIRECTION.pageFade);
            ...
            this._switchToDocument(state.url.full, false, false, DIRECTION.pageFade);
            this._saveAsCurrentState(state);
        }
    };
